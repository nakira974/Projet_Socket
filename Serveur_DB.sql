...
CREATE
USER 'ServerMaster'@'localhost' IDENTIFIED VIA mysql_native_password USING '***';
GRANT ALL PRIVILEGES ON *.* TO
'ServerMaster'@'localhost' REQUIRE NONE WITH GRANT OPTION
MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0
MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;
GRANT ALL PRIVILEGES ON `servermaster\_%`.* TO
'ServerMaster'@'localhost' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON `serveur_db`.* TO
'ServerMaster'@'localhost' WITH GRANT OPTION;
